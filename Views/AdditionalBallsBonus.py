...
class AdditionalBallsBonus(AbstractBonusObject):
    ...
    def __init__(self, x_position: float, y_position: float,
                 ...
                 is_active: bool,
                 balls_number: float):
        super().__init__(x_position, y_position, height, width, color,
                         True, speed, move_direction, radius, is_active)
    ...
    def activate(self, target: "GameScreen"):
        ...
        for i in range(int(self.balls_number)):
            ...
            target.balls.append(BallObject(new_x, new_y, 10, 10,
                                pygame.Color(255, 0, 0), 5, [1, 1], 5, True))
        self.is_active = True
